            ...
            <ul>
                <li>資訊
                    <ul>
                        ...
                        <li>成員
                            <ul>
                                <li><a href="member_1.php">教師與助教</a></li>
                                <li><a href="member_2.php">學生</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
                ...
                <li>內容
                    <ul>
                        <li>大綱
                            <ul>
                                <li><a href="introduction.php">大綱列表</a></li>
                            </ul>
                        </li>
                        <li>文件
                            <ul>
                                <li><a href="documentation.php">文件列表</a></li>
                            </ul>
                        </li>
                        <li>作業
                            <ul>
                                <li><a href="assignment.php">作業列表</a></li>
                                <li><a href="assignment-display.php">作業展示</a></li>
                            </ul>
                        </li>
                        <li>討論
                            <ul>
                                <li><a href="communication.php">討論區列表</a></li>
                            </ul>
                        </li>
                        <li>測驗
                            <ul>
                                <li><a href="test.php">試卷列表</a></li>
                            </ul>
                        </li>
                        <li>問券
                            <ul>
                                <li><a href="question.php">問卷列表</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="watching.php">觀摩</a>
                        </li>
                    </ul>
                </li>
                <li>評量
